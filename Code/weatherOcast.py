...
def GUI():
    ...
    snow_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\snow.png"), size=(48, 48))
    search_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\Search.png"))
    location_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\location.png"), size=(40, 40))
    world_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\world.png"))
    temp_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\temperature.png"), size=(48, 48))
    fell_like_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\fell_like1.png"), size=(40, 40))
    pressure_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\atmosphere_Pressure.png"), size=(40, 40))
    humidity_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\humidity.png"), size=(40, 40))
    wind_speed_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\wind_speed.png"), size=(40, 40))
    sunrise_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\sunrise.png"), size=(40, 40))
    sunset_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\sunset.png"), size=(40, 40))
    country_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\world.png"), size=(40, 40))
    weather_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\weather.png"), size=(50, 50))
    clear_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\clear.png"), size=(100, 100))
    partly_cloud_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\partly_clouds.png"), size=(100, 100))
    cloudy_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\clouds.png"), size=(100, 100))
    overcast_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\overcast.png"), size=(100, 100))
    rain_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\rain.png"), size=(100, 100))
    drizzle_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\drizzle.png"), size=(100, 100))
    thunderstorm_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\thunderstorm.png"), size=(100, 100))
    snow_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\snow.png"), size=(100, 100))
    fog_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\fog.png"), size=(100, 100))
    mist_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\mist.png"), size=(100, 100))
    dust_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\dust.png"), size=(100, 100))
    haze_img = CTkImage(Image.open(r"C:\Users\yashg\OneDrive\Desktop\APP Final\Python Program\weather\haze.png"), size=(100, 100))
